...
namespace Game.Scripts.JsonAnimationImporter {
    public class PositionAnimation : IAnimation {
        public async UniTaskVoid PlayAnimation(ImageAnimationElement animationParameter, Image image) {
            if (animationParameter.BasePropertyAnimator is PositionPropertyAnimator positionPropertyAnimator) {
                if (animationParameter.TransformProperties.Position.Values is AnimatedAnimationParameter animatedAnimationParameter) {
                ...
                else if (animationParameter.TransformProperties.Position.Values is StaticAnimationParameter staticAnimationParameter) {
                ...
                else if (animationParameter.TransformProperties.Position.Values is StaticSingleValue staticSingleValue) {
